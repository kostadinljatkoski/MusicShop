...
import mk.ukim.finki.emt.musicshop.ordermanagement.domain.model.OrderItemId;
...
public class OrderItemAdded implements DomainEvent {
    ...
    public OrderItemAdded(OrderId orderId, OrderItemId orderItemId, AlbumId albumId, int quantity, Instant occurredOn) {
